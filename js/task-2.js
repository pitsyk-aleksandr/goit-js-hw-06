...
class Storage {
    ...
    removeItem(itemToRemove) {
        // Перевіряємо на наявність в масиву елемента, що повивен видалитися
        if (this.#items.includes(itemToRemove)) {
            // Пошук індекса елемента, що видаляється
            const idxItem = this.#items.indexOf(itemToRemove);
            // Видаляється з масиву 1 елемент за індексом
